...
```
src/main/kotlin/org/limepepper/gdb_plugin/
├── GdbFileType.kt                 # File type definition
├── GdbLanguage.kt                 # Language definition  
├── lexer/
│   ├── GdbLexer.flex             # JFlex lexer specification
│   └── GdbLexerAdapter.kt        # Lexer adapter
├── highlighting/
│   ├── GdbSyntaxHighlighter.kt   # Syntax highlighter
│   └── GdbColorSettingsPage.kt   # Color settings
├── formatting/
│   ├── GdbFormattingModelBuilder.kt
│   └── GdbBlock.kt
├── psi/
│   ├── GdbElementTypes.kt        # Token and element types
│   └── GdbPsiElement.kt          # PSI element interfaces
└── documentation/
    └── GdbDocumentationProvider.kt
```

## Testing Strategy

- Unit tests for lexer and syntax highlighting
- Integration tests with IntelliJ Platform test framework
- UI tests for color settings and formatting
- Plugin verification tests for compatibility
