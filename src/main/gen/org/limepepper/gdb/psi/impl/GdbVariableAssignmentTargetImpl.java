...
public class GdbVariableAssignmentTargetImpl extends ASTWrapperPsiElement implements GdbVariableAssignmentTarget {

  public GdbVariableAssignmentTargetImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull GdbVisitor visitor) {
    visitor.visitVariableAssignmentTarget(this);
  }
