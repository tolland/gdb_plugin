...
public class GdbCommandBlockImpl extends ASTWrapperPsiElement implements GdbCommandBlock {

  public GdbCommandBlockImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<GdbCommandLine> getCommandLineList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, GdbCommandLine.class);
  }
