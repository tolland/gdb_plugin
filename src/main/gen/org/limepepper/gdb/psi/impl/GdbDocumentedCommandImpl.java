...
public class GdbDocumentedCommandImpl extends ASTWrapperPsiElement implements GdbDocumentedCommand {

  public GdbDocumentedCommandImpl(@NotNull ASTNode node) {
    super(node);
  }
