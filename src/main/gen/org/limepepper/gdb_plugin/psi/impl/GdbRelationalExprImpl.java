...
public class GdbRelationalExprImpl extends ASTWrapperPsiElement implements GdbRelationalExpr {

  public GdbRelationalExprImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public List<GdbAdditiveExpr> getAdditiveExprList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, GdbAdditiveExpr.class);
  }
