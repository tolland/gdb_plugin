...
object GdbTokenTypes {
    ...
    @JvmField val COMMAND_STACK = GdbTokenType("COMMAND_STACK")             // backtrace, frame, up, down
    @JvmField val COMMAND_DATA = GdbTokenType("COMMAND_DATA")               // print, x, display, info
    ...
    @JvmField val BAD_CHARACTER = GdbTokenType("BAD_CHARACTER")
}
