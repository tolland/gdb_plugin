...
public class GdbCodeBlockStartImpl extends GdbPsiElement implements GdbCodeBlockStart {

  public GdbCodeBlockStartImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull GdbVisitor visitor) {
    visitor.visitCodeBlockStart(this);
  }
