...
public class GdbDocBlockImpl extends GdbPsiElement implements GdbDocBlock {

  public GdbDocBlockImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull GdbVisitor visitor) {
    visitor.visitDocBlock(this);
  }
  ...
  @Override
  @NotNull
  public GdbDocBlockBody getDocBlockBody() {
    return findNotNullChildByClass(GdbDocBlockBody.class);
  }
