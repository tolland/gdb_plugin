...
public class GdbTextBlockStartImpl extends GdbPsiElement implements GdbTextBlockStart {

  public GdbTextBlockStartImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull GdbVisitor visitor) {
    visitor.visitTextBlockStart(this);
  }
